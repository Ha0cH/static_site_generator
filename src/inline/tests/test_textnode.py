import unittest
from inline.textnode import TextNode, TextType, text_node_to_html_node
...
class TestTextNode(unittest.TestCase):
    ...
    def test_repr(self):
        ...
        expected_repr = "TextNode(text: This is a text node, text_type: TextType.IMAGE, url: https://example.com/image.png)"
    ...
    def test_image_to_html(self):
        node = TextNode("This is an image node", TextType.IMAGE, url="https://example.com/image.png")
        html_node = text_node_to_html_node(node)
